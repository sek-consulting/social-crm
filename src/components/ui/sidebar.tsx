import type { Accessor, Component, ComponentProps, ValidComponent } from "solid-js"
import {
  createContext,
  createEffect,
  createMemo,
  ...
  return (
    <Switch>
      <Match when={local.collapsible === "none"}>
        <div
          class={cn(
            "bg-sidebar text-sidebar-foreground test flex h-full w-[--sidebar-width] flex-col",
            local.class
          )}
          {...others}
        >

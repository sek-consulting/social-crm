...
const DialogTrigger: typeof DialogPrimitive.Trigger = (props) => {
  const [, rest] = splitProps(props, ["children"])
  return <DialogPrimitive.Trigger {...rest}>{props.children}</DialogPrimitive.Trigger>
}

const DialogPortal: typeof DialogPrimitive.Portal = (props) => {
  const [, rest] = splitProps(props, ["children"])
  return (
...
const DialogOverlay: typeof DialogPrimitive.Overlay = (props) => {
...
const DialogContent: typeof DialogPrimitive.Content = (props) => {
...
const DialogTitle: typeof DialogPrimitive.Title = (props) => {
  const [, rest] = splitProps(props, ["class"])
  return (
...
const DialogDescription: typeof DialogPrimitive.Description = (props) => {
  const [, rest] = splitProps(props, ["class"])
  return (
